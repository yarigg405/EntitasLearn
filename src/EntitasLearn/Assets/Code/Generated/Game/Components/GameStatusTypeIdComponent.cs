...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Statuses.StatusTypeIdComponent statusTypeId { get { return (Assets.Code.Gameplay.Features.Statuses.StatusTypeIdComponent)GetComponent(GameComponentsLookup.StatusTypeId); } }
    ...
    public GameEntity AddStatusTypeId(Assets.Code.Gameplay.Features.Statuses.StatusTypeId newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Statuses.StatusTypeIdComponent)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Statuses.StatusTypeIdComponent));
