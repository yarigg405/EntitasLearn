...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Abilities.Cooldowns.CooldownComponents.Cooldown cooldown { get { return (Assets.Code.Gameplay.Features.Abilities.Cooldowns.CooldownComponents.Cooldown)GetComponent(GameComponentsLookup.Cooldown); } }
    ...
    public GameEntity AddCooldown(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Abilities.Cooldowns.CooldownComponents.Cooldown)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Abilities.Cooldowns.CooldownComponents.Cooldown));
