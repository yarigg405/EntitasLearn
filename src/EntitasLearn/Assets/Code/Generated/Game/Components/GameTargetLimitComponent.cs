...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.TargetLimit targetLimit { get { return (Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.TargetLimit)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.TargetLimit));
