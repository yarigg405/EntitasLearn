...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.StatusSetups statusSetups { get { return (Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.StatusSetups)GetComponent(GameComponentsLookup.StatusSetups); } }
    ...
    public GameEntity AddStatusSetups(System.Collections.Generic.List<Assets.Code.Gameplay.Features.Statuses.StatusSetup> newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.StatusSetups)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Abilities.Armaments.ArmamentComponents.StatusSetups));
