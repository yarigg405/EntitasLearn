...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Statuses.TimeSinceLastTick timeSinceLastTick { get { return (Assets.Code.Gameplay.Features.Statuses.TimeSinceLastTick)GetComponent(GameComponentsLookup.TimeSinceLastTick); } }
    ...
    public GameEntity AddTimeSinceLastTick(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Statuses.TimeSinceLastTick)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Statuses.TimeSinceLastTick));
