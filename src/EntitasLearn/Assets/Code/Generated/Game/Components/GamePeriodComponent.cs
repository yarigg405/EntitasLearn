...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Statuses.Period period { get { return (Assets.Code.Gameplay.Features.Statuses.Period)GetComponent(GameComponentsLookup.Period); } }
    ...
    public GameEntity AddPeriod(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Statuses.Period)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Statuses.Period));
