...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Common.Movement.Speed speed { get { return (Assets.Code.Gameplay.Common.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Common.Movement.Speed)CreateComponent(index, typeof(Assets.Code.Gameplay.Common.Movement.Speed));
