...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Common.Movement.OrbitRadius orbitRadius { get { return (Assets.Code.Gameplay.Common.Movement.OrbitRadius)GetComponent(GameComponentsLookup.OrbitRadius); } }
    ...
    public GameEntity AddOrbitRadius(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Common.Movement.OrbitRadius)CreateComponent(index, typeof(Assets.Code.Gameplay.Common.Movement.OrbitRadius));
