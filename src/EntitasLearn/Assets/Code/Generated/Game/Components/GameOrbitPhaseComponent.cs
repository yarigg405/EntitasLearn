...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Common.Movement.OrbitPhase orbitPhase { get { return (Assets.Code.Gameplay.Common.Movement.OrbitPhase)GetComponent(GameComponentsLookup.OrbitPhase); } }
    ...
    public GameEntity AddOrbitPhase(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Common.Movement.OrbitPhase)CreateComponent(index, typeof(Assets.Code.Gameplay.Common.Movement.OrbitPhase));
