...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Loot.PickupRadius pickupRadius { get { return (Assets.Code.Gameplay.Features.Loot.PickupRadius)GetComponent(GameComponentsLookup.PickupRadius); } }
    ...
    public GameEntity AddPickupRadius(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Loot.PickupRadius)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Loot.PickupRadius));
