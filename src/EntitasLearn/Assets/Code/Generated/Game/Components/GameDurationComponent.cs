...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Statuses.Duration duration { get { return (Assets.Code.Gameplay.Features.Statuses.Duration)GetComponent(GameComponentsLookup.Duration); } }
    ...
    public GameEntity AddDuration(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Statuses.Duration)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Statuses.Duration));
