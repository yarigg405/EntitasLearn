...
public partial class MetaEntity {
    ...
    public Assets.Code.Meta.Features.Simulation.Tick tick { get { return (Assets.Code.Meta.Features.Simulation.Tick)GetComponent(MetaComponentsLookup.Tick); } }
    ...
    public MetaEntity AddTick(float newValue) {
        ...
        var component = (Assets.Code.Meta.Features.Simulation.Tick)CreateComponent(index, typeof(Assets.Code.Meta.Features.Simulation.Tick));
