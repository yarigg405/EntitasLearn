...
public partial class MetaEntity {
    ...
    public Assets.Code.Meta.Features.Simulation.Duration duration { get { return (Assets.Code.Meta.Features.Simulation.Duration)GetComponent(MetaComponentsLookup.Duration); } }
    ...
    public MetaEntity AddDuration(float newValue) {
        ...
        var component = (Assets.Code.Meta.Features.Simulation.Duration)CreateComponent(index, typeof(Assets.Code.Meta.Features.Simulation.Duration));
